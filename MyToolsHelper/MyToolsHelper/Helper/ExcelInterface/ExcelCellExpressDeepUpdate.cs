...
namespace PPPayReportTools.ExcelInterface
{
    public class ExcelCellExpressDeepUpdate<T> : IExcelCellExpressDeepUpdate<T>
    {
        ...
        public ExcelCellExpressDeepUpdate(
            Action<ICellModel> updateCellPointFunc, 
            Func<T, bool> checkIsContinuteFunc,
        ...
        private List<ICellModel> GetCellModelList(string cellExpress)
        {
            ...
            {
                cellModelList.Add(this.cellFactory.GetCellByExcelPosition(matchItem.Value));
            }
